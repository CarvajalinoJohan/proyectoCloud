...
{               ?>
                                    ...
                                    <li><a class="toolbar-new-listing" href="admin/login.php"><i class="fa fa-plus-circle"></i> Loguin</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="nav-wrapper"><!--main navigation-->
                <div class="container">
                    ...
                    <nav class="wsmenu slideLeft clearfix">
                        <div class="logo pull-left"><a href="index.php" title="Responsive Slide Menus"><h3 style="color:#18224A">EmpleaMe</h3></a></div>
