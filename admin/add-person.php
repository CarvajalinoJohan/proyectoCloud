...
$sql="insert into tblperson(Category,Name,Picture,MobileNumber,Address,City,Experiences)values(:cat,:name,:pics,:mobilenumber,:address,:city,:experiences)";
...
$query->bindParam(':experiences',$experiences,PDO::PARAM_STR);
...
<head>
  ...
  <title>Empleame | Agregar Persona</title>
...
<option value="<?php echo htmlentities($row->Category);?>"><?php echo htmlentities($row->Category);?></option>
 <?php } ?> 
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="experiences" name="experiences" placeholder="ex" >
                  </div>  
                  <!-- <div class="form-group">
                    <label for="exampleInputEmail1">Ciudad</label>
                    <input type="text" class="form-control" id="e2" name="city" placeholder="Ciudad" >
                  </div>  
                  <div class="form-group">
                    <label for="exampleInputEmail1">Ciudad</label>
                    <input type="text" class="form-control" id="e3" name="city" placeholder="Ciudad" >
                  </div>  
                </div> -->
