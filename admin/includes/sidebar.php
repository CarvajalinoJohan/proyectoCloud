 <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.php" class="brand-link" style="font-weight:bold; font-size:22px;">
      ...
      <span class="brand-text font-weight-light">Empleame</span>
    </a>
...
$cnt=1;
// userEmployer = empleador
// userEmployee = empleado
if($query->rowCount() > 0)
{
foreach($results as $row)
{
    ...
    ?>
          ...
          <?php $cnt=$cnt+1;}}
$moduloNamePerson = 'Lista de Personas';
$moduloNamePersonList = 'Agregar Personas';
if ($adminName == 'userEmployee'){
    $moduloNamePerson = 'Registro Personal';
    $moduloNamePersonList = 'Registro';
}
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                <?php if($adminName == 'Admin' || $adminName= 'userEmployer'){ ?>
              <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="add-person.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p><?php echo ($moduloNamePersonList);?></p>
                </a>
              </li>
                <?php if($adminName == 'Admin' || $adminName =='userEmployer'){ ?>
              <li class="nav-item">
